...
export const WhatsAppButton = () => {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#128C7E] flex items-center justify-center shadow-[0_0_20px_rgba(18,140,126,0.5)] text-white"
    >
