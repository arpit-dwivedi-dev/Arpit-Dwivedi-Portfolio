  ...
  return (
    <Modal title="Help & shortcuts" onClose={onClose}>
      <div className="space-y-4 text-sm">
        <div>
          <h3 className="text-xs font-semibold uppercase tracking-wide text-slate-500 mb-1.5">How it works</h3>
        ...
        <div>
          <h3 className="text-xs font-semibold uppercase tracking-wide text-slate-500 mb-1.5">Keyboard shortcuts</h3>
          <dl className="space-y-1">
            {SHORTCUTS.map(([keys, desc]) => (
              <div key={keys} className="flex items-center justify-between gap-3">
                <dt className="text-slate-400">{desc}</dt>
                <dd>
                  <kbd className="rounded border border-slate-700 bg-slate-800 px-1.5 py-0.5 text-[11px] font-mono text-slate-300">
                    {keys}
                  </kbd>
                </dd>
              </div>
        ...
        <div>
          <h3 className="text-xs font-semibold uppercase tracking-wide text-slate-500 mb-1.5">Everything stays local</h3>
          <p className="text-slate-300">
