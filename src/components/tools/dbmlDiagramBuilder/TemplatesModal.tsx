        ...
        {TEMPLATES.map((template) => (
          <li key={template.id}>
            <button
              ...
              className="w-full text-left rounded-md border border-slate-800 hover:border-blue-500 hover:bg-slate-800/50 px-3 py-2.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-500"
            >
