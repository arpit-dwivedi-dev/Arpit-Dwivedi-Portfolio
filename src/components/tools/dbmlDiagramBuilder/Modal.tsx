  ...
  return (
    ...
    >
      <div
        ...
        aria-modal="true"
        aria-label={title}
        className={`w-full ${widthClass} rounded-lg border border-slate-700 bg-slate-900 shadow-xl text-slate-100 max-h-full flex flex-col`}
      >
        <div className="flex items-center justify-between px-4 py-3 border-b border-slate-800 shrink-0">
          ...
          <button
            ...
            className="w-7 h-7 flex items-center justify-center rounded hover:bg-slate-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-500"
          >
            <X size={15} />
          </button>
        </div>
