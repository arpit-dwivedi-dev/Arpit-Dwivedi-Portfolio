  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-4 sm:mb-6">
        <div className="bg-accent-blue/10 text-accent-blue w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
          <Icon className="w-5 h-5 sm:w-6 sm:h-6" aria-hidden="true" />
        </div>
        <ArrowUpRight
          className="w-[18px] h-[18px] sm:w-5 sm:h-5 text-secondary-text group-hover:text-accent-blue group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all"
          aria-hidden="true"
        />
      </div>

      <h3 className="text-lg sm:text-xl font-bold text-ink mb-2 sm:mb-3 group-hover:text-accent-blue transition-colors">{title}</h3>
