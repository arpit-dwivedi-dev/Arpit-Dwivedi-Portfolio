      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="space-y-6 text-lg text-secondary-text leading-relaxed">
            <p>
              I am a <span className="text-white font-medium">Experience Full-Stack Developer</span> building scalable systems and AI-powered solutions. My approach combines deep technical expertise with a product-focused mindset.
            </p>
            <p>
