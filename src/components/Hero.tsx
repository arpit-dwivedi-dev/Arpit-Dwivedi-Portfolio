  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full glass text-xs font-mono text-accent-blue mb-6">
          ...
          <p className="text-lg md:text-xl text-secondary-text max-w-xl mb-10 leading-relaxed">
            Building scalable systems, AI-powered solutions, and high-performance applications. 
            Specializing in the <span className="text-white font-medium">MEAN Stack</span> and distributed architectures.
          </p>

          <div className="flex flex-wrap gap-4 mb-12">
            <div className="flex flex-col gap-1 px-4 py-2 rounded-xl glass">
              <span className="text-2xl font-bold text-white">4+</span>
              <span className="text-[10px] uppercase tracking-widest text-secondary-text font-mono">Years Exp</span>
            </div>
            <div className="flex flex-col gap-1 px-4 py-2 rounded-xl glass">
              <span className="text-2xl font-bold text-white">15+</span>
              <span className="text-[10px] uppercase tracking-widest text-secondary-text font-mono">Projects</span>
            </div>
            <div className="flex flex-col gap-1 px-4 py-2 rounded-xl glass">
              <span className="text-2xl font-bold text-white">AI</span>
              <span className="text-[10px] uppercase tracking-widest text-secondary-text font-mono">Specialist</span>
            </div>
          </div>
        ...
        >
          ...
          <div className="w-full aspect-video rounded-2xl glass p-1 glow-blue relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-full h-8 bg-white/5 border-b border-white/10 flex items-center px-4 gap-2">
              ...
              <div className="ml-4 text-[10px] font-mono text-secondary-text">arpit_dwivedi -- portfolio_v2.ts</div>
            </div>
            <div className="mt-8 p-6 font-mono text-sm space-y-2">
              ...
              <div className="pl-4 flex gap-2">
                ...
                <span className="text-yellow-400">'Arpit Dwivedi'</span>,
              </div>
              <div className="pl-4 flex gap-2">
                <span className="text-secondary-text">role:</span>
                <span className="text-yellow-400">'Full-Stack Specialist'</span>,
              </div>
              <div className="pl-4 flex gap-2">
                <span className="text-secondary-text">stack:</span>
                <span className="text-white">['MEAN', 'AI', 'DevOps']</span>,
              </div>
              <div className="pl-4 flex gap-2">
                <span className="text-secondary-text">mission:</span>
                <span className="text-yellow-400">'Building Scalable Future'</span>
              </div>
              <div className="flex gap-2">
                <span className="text-white">{"}"}</span>;
              </div>
            ...
            <div className="absolute bottom-4 right-4 w-32 h-20 glass rounded-lg p-2 flex flex-col justify-between border-accent-blue/30">
              <div className="text-[8px] font-mono text-accent-blue uppercase tracking-tighter">System Load</div>
